...
public interface IRepository<T> where T : class
{
    ...
    /// </returns>
    Task<T> AddAsync(T value, bool shouldSave = false);
    ...
    /// Defaults to <c>false</c>.</param>
    Task AddRangeAsync(IEnumerable<T> values, bool shouldSave = false);
    ...
    Task<T> UpdateAsync(T value, bool shouldSave = false);
    ...
    Task RemoveAsync(T value, bool shouldSave = false);
    ...
    /// Defaults to <c>false</c>.</param>
    /// <returns>A task that represents the asynchronous remove operation.</returns>
    Task RemoveRangeAsync(IEnumerable<T> values, bool shouldSave = false);
